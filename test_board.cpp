...
namespace testhistogram
{
	...
	public:
		...
		TEST_METHOD(flagged1)
        {
			Board b1(5,5,5);
            b1.flagCell(2, 2);
			Assert::AreEqual(isCellFlag(2,2), true);
        }
		...
		TEST_METHOD(flagged2)
        {
			Board b1(10,10,5);
            b1.flagCell(5, 5);
			Assert::AreEqual(isCellFlag(5,5), true);
        }
		...
		TEST_METHOD(unflagged1)
        {
			Board b1(5,5,5);
            b1.unflagCell(5, 5);
			Assert::AreEqual(isCellFlag(5,5), false);
        }
		...
		TEST_METHOD(open1)
        {
			Board b1(5,5,5);
            b1.openCell(5, 5);
			Assert::AreEqual(isCellOpen(5,5), true);
        }
		...
		TEST_METHOD(open2)
        {
			Board b1(5,5,5);
            b1.openCell(1, 1);
			Assert::AreEqual(isCellOpen(5,5), false);
        }
